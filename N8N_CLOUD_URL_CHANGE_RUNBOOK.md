...
Replace:
```js
const n8nUrl = process.env.N8N_EMAIL_WEBHOOK_URL || 'https://cmpuntg10.app.n8n.cloud/webhook/email-master-listener';
```
With:
```js
...
```
```js
const DEFAULT_LEAD_HUNTER_WEBHOOK_URL = 'https://cmpuntg10.app.n8n.cloud/webhook/lead-hunter-start';
```

### Backend: `server/services/leadHunterQueue.js`
Replace:
```js
const DEFAULT_SENDER_WEBHOOK_URL = 'https://cmpuntg10.app.n8n.cloud/webhook/lead-hunter-sender';
```
...
From repo root:
```powershell
rg -n "cmpuntg10.app.n8n.cloud|<your-new-subdomain>.app.n8n.cloud" -S server src .env.example RENDER_DEPLOYMENT.md
```
