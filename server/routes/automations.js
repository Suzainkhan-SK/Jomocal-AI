...
const DEFAULT_LEAD_HUNTER_WEBHOOK_URL = 'https://cmpunktg10.app.n8n.cloud/webhook/stateless-hunter';
...
function buildHunterWebhookCandidates() {
    ...
    const baseUrl = process.env.N8N_WEBHOOK_BASE_URL || 'https://cmpunktg10.app.n8n.cloud';
