        ...
        <div className="min-h-screen flex flex-col bg-body relative selection:bg-blue-500/30 selection:text-white transition-colors">
            ...
            <header ref={heroRef} className="relative pt-20 pb-12 md:pt-36 md:pb-40 overflow-hidden bg-body transition-colors">
                ...
                <div className="container relative z-10 px-4 text-center max-w-5xl">
                    ...
                    >
                        𝙰𝚞𝚝𝚘𝚖𝚊𝚝𝚎 𝚢𝚘𝚞𝚛 <br className="hidden md:block" />
                    ...
                    >
                        ...
                        <span className="hidden md:inline">From replying to DMs to creating full YouTube videos—Jomocal AI handles the busy work so you can focus on building.</span>
                    </motion.p>
            ...
            <div className="relative -mt-4 md:-mt-12 z-20 px-2 sm:px-4 pb-12 md:pb-20">
                ...
                >
                    <div className="relative rounded-xl md:rounded-3xl bg-surface/5 p-1 md:p-3 ring-1 ring-inset ring-main/10 backdrop-blur-sm transition-colors">
            ...
            {/* --- TRUSTED BY --- */}
            < section className="py-6 md:py-10 border-y border-main bg-body shadow-sm overflow-hidden relative transition-colors" >
                ...
                <div className="container mb-6 md:mb-8 text-center text-secondary">
                    <p className="text-[10px] md:text-xs font-bold uppercase tracking-widest font-sans">Powering 2,500+ Businesses</p>
                </div>
                    ...
                    <div className="animate-marquee flex gap-8 md:gap-24 items-center whitespace-nowrap min-w-full">
                        ...
                        {[...Array(6)].map((_, setIndex) => (
                            <React.Fragment key={setIndex}>
                                ...
                                <div className="flex items-center gap-2 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-500 cursor-pointer">
                                    <ShieldCheck className="w-5 h-5 md:w-6 md:h-6 text-emerald-400" /> <span className="text-lg md:text-xl font-bold text-secondary font-display">SecureAI</span>
                                </div>
                                <div className="flex items-center gap-2 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-500 cursor-pointer">
            ...
            {/* --- SOLUTIONS FOR WHO? --- */}
            < section className="py-12 md:py-32 bg-body transition-colors" >
                <div className="container px-4">
                    <div className="text-center max-w-3xl mx-auto mb-10 md:mb-20">
                        <h2 className="text-2xl md:text-5xl font-bold mb-4 md:mb-6 text-main font-display transition-colors">Tailored for your success</h2>
                        <p className="text-sm md:text-lg text-secondary font-light transition-colors">Whether you run a business or create content, Jomocal AI adapts your needs.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
                        ...
                        <motion.div
                            whileHover={{ y: -6 }}
                            className="group p-6 md:p-10 rounded-3xl bg-surface border-2 border-main shadow-xl hover:border-blue-500/50 transition-all duration-300 relative overflow-hidden"
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-xl md:text-3xl font-bold mb-2 md:mb-4 text-main font-display transition-colors">Small Business</h3>
                                ...
                                <ul className="space-y-3 md:space-y-4 mb-8 md:mb-10">
                                    <li className="flex items-start gap-2.5 md:gap-3 text-secondary font-medium text-xs md:text-base transition-colors">
                                        ...
                                        <span className="text-secondary">Auto-reply to leads 24/7</span>
                                    </li>
                                    <li className="flex items-start gap-2.5 md:gap-3 font-medium text-xs md:text-base transition-colors">
                                        <CheckCircle size={16} className="text-blue-400 shrink-0 mt-0.5" />
                                        <span className="text-secondary">Automated invoice reminders</span>
                                    </li>
                                    <li className="flex items-start gap-2.5 md:gap-3 font-medium text-xs md:text-base transition-colors">
                                        <CheckCircle size={16} className="text-blue-400 shrink-0 mt-0.5" />
                                        <span className="text-secondary">Capture leads from Maps</span>
                                    </li>
                        ...
                        <motion.div
                            whileHover={{ y: -6 }}
                            className="group p-6 md:p-10 rounded-3xl bg-surface border-2 border-main shadow-xl hover:border-purple-500/50 transition-all duration-300 relative overflow-hidden"
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-xl md:text-3xl font-bold mb-2 md:mb-4 text-main font-display transition-colors">Digital Creators</h3>
                                <p className="text-xs md:text-base text-secondary mb-6 md:mb-8 leading-relaxed transition-colors">
            ...
            < section id="features" className="py-12 md:py-24 bg-body relative transition-colors" >
                ...
                <div className="container px-4">
                    <div className="text-center max-w-3xl mx-auto mb-10 md:mb-20">
                        <h2 className="text-2xl md:text-5xl font-bold mb-4 md:mb-6 text-main font-display transition-colors">Power-Packed Automation</h2>
                        <p className="text-sm md:text-lg text-secondary font-light transition-colors">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-4 gap-4 md:gap-6 max-w-7xl mx-auto">
                        ...
                        <div className="md:col-span-6 lg:col-span-4 card group relative overflow-hidden bg-surface text-main border-main p-6 md:p-8 transition-colors">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <h3 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 font-display text-main transition-colors">YouTube AI Automation</h3>
                                    ...
                                    <div className="flex flex-wrap gap-2 md:gap-3 justify-center md:justify-start">
                                        ...
                                        <span className="px-2 md:px-3 py-1 bg-surface rounded-lg text-[10px] md:text-xs font-medium text-secondary border border-main flex items-center gap-1 transition-colors"><Video size={12} /> Auto-Edit</span>
                                        <span className="px-2 md:px-3 py-1 bg-surface rounded-lg text-[10px] md:text-xs font-medium text-secondary border border-main flex items-center gap-1 transition-colors"><UploadCloud size={12} /> Auto-Upload</span>
                                    </div>
                                </div>
                ...
                <div className="container text-center px-4 relative z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
                            <Link to="/signup" className="btn bg-blue-600 text-white hover:bg-blue-700 text-base md:text-lg px-8 md:px-10 py-3 md:py-5 shadow-2xl shadow-blue-900/20 border-none font-bold">
                                Get Started Free
                            </Link>
            ...
            < footer className="bg-body text-secondary py-12 md:py-16 border-t border-main font-sans transition-colors" >
                <div className="container px-4">
                    ...
                    <div className="border-t border-main pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-secondary text-xs md:text-sm transition-colors">
                        <p>&copy; {new Date().getFullYear()} Jomocal AI.</p>
